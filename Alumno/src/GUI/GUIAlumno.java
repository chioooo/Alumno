...
public class GUIAlumno extends JFrame implements ActionListener {
    ...
    private void añadirAlumno() {
        Alumno p = new Alumno(cNumero.getText(), cNombre.getText(),
                (Byte.parseByte(cSemestre.getText())), (Byte.parseByte
                (cEdad.getText())));
        lista.Añadir(p);
        String cad = cNombre.getText() + " " + cNumero.getText() +
                " "+ cSemestre.getText() + " " + cEdad.getText();
